        ...
        <div class="my-auto">
            <form id="review-form" action="includes/review-helper.php" method="post">
                ...
                <div class="form-group" style="margin-top: 15px;">
                    <label class="title-label" form="review-title" style="font-size: 16px; font-weight:bold;">Title</label>
                    <input type="text" name="review-title" id="review-title" style="width: 100%; margin-bottom: 10px;">
                    <textarea id="review-text" name="review" cols="80" rows="3" placeholder="Enter a comment..."></textarea>
